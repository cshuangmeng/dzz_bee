...
import com.yixiang.api.filter.CorsFilter;
import com.yixiang.api.filter.LoginAuthorizationFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
		...
		filterChainDefinitionMap.put("/upload/media", "corsFilter,anon");
		filterChainDefinitionMap.put("/**", "corsFilter,token");
